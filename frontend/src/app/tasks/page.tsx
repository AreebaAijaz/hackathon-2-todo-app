...
export default function TasksPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--background)] pb-20">
      ...
      <Link
        href="/chat"
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full gradient-bg flex items-center justify-center shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-105 ring-4 ring-white dark:ring-[var(--background)]"
